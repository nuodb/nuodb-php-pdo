...
$db_insert_placeholder_19 = "with a nul char \000 test.";
...
$db_insert_placeholder_22 = 'modules/node/node.pages.inc';
  ...
  $stmt5->bindParam(':db_insert_placeholder_8', $db_insert_placeholder_8, PDO::PARAM_INT);
  $stmt5->bindParam(':db_insert_placeholder_9', $db_insert_placeholder_9, PDO::PARAM_INT);
  $stmt5->bindParam(':db_insert_placeholder_10', $db_insert_placeholder_10, PDO::PARAM_INT);
